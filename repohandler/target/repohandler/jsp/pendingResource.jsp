...
<%
 	...
 	rs=stat.executeQuery(" select additional_material_description,topics.topic_name from additional_material,topics,resources where additional_material.userid="+uid+"  and activity=0 and additional_material.resources_id=resources.resources_id and resources.topic_id=topics.topic_id;");
    Integer i=0;
%>	
	<br><br>
...
<%
	...
	rs=stat.executeQuery(" select tutorial_name,topics.topic_name from tutorial,topics,resources where tutorial.userid="+ uid +"  and activity=0 and tutorial.resources_id=resources.resources_id and resources.topic_id=topics.topic_id ");
    Integer j=0;
%>	
	<br><br>
	<table border=1 style='border-collapse:collapse;width:80%'>
...
<%
	...
	rs=stat.executeQuery(" select phet_name,topics.topic_name from phet,topics,resources where phet.userid="+ uid +"  and activity=0 and phet.resources_id=resources.resources_id and resources.topic_id=topics.topic_id");
    Integer k=0;
%>	
	<br><br>
	<table  border=1 style='border-collapse:collapse;width:80%'>
...
<%
	...
	rs=stat.executeQuery(" select description,topics.topic_name from mindmap,topics,resources where mindmap.userid="+ uid +"  and activity=0 and mindmap.resources_id=resources.resources_id and resources.topic_id=topics.topic_id");
    Integer l=0;
%>	
	<br><br>
	<table border=1 style='border-collapse:collapse;width:80%'>
