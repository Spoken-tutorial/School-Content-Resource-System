...
CREATE TABLE `resources_type` (
  `resources_type_id` int(11) NOT NULL AUTO_INCREMENT,
  `resources_type_name` varchar(45) DEFAULT NULL,
...
INSERT INTO `resources_type` VALUES (1,'Additional Resources'),(2,'Tutorial'),(3,'Phet'),(4,'Mindmap');
